 ...
 */
public class ChangeRoleEmployeeQueryIT extends AbstractTemplateTestCase {

    private static final Logger log = LoggerFactory.getLogger(ChangeRoleEmployeeQueryIT.class);
